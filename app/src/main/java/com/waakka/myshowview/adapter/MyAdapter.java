...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyHolder> {
    ...
    private JsonBeen been;
    private Typeface typeface;

    public MyAdapter(Context context, JsonBeen been, Typeface typeface){
        this.been = been;
    ...
    public void onBindViewHolder(@NonNull MyHolder myHolder, int i) {
        ItemBeen dataBeen = been.getData().get(i);
        if (i % 2 == 0){
            myHolder.rootview.setBackgroundColor(Color.parseColor("#ffebae"));
        }else{
            myHolder.rootview.setBackgroundColor(Color.parseColor("#fff9e5"));
        }
        ...
        myHolder.tv1.setText(been.getUsername());

        myHolder.tv2.setText(doubleToString(dataBeen.getChargeNum())+" ");
        myHolder.tv2.append(m1);
        myHolder.tv3.setText(doubleToString(dataBeen.getPrice())+" 元/");
        myHolder.tv3.append(m1);

        myHolder.tv4.setText(dataBeen.getChargeDate());
        myHolder.tv5.setText(doubleToString(dataBeen.getChargeMoney()) + " 元");
    }
